...
# Note: probably best not to use more than 2 cores
...
mclapply(vi_list, to_month, mc.cores = 2, mc.preschedule = FALSE, in_dir = daily_vi_dir, out_dir = output_dir, tmpdir = tmpdir)
